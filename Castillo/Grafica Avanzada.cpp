...
int main()
{
	...
	float vertices[]{
		-0.8f, -1.0f, 0.0f, //izquierda
		-0.5f, -1.0f, 0.0f,  //derecha
		...
		0.5f, -1.0f, 0.0f,  //derecha
		0.8f, 0.5f, 0.0f,    //arriba
		-0.5f, -0.2f, 0.0f, //izquierda
		-0.5f, -1.0f, 0.0f,  //derecha
		0.5f, -1.0f, 0.0f,    //arriba
		0.5f, -0.2f, 0.0f, //izquierda
		0.5f, -1.0f, 0.0f,  //derecha
		-0.5f, -0.2f, 0.0f,    //arriba
		-0.2f, -0.2f, 0.0f, //izquierda
		0.2f, -0.2f, 0.0f,  //derecha
		-0.2f, 0.1f, 0.0f,    //arriba
		0.2f, 0.1f, 0.0f, //izquierda
		0.2f, -0.2f, 0.0f,  //derecha
		-0.2f, 0.1f, 0.0f,    //arriba
		-0.1f, 0.1f, 0.0f, //izquierda
		0.1f, 0.1f, 0.0f,  //derecha
		-0.1f, 0.4f, 0.0f,    //arriba
		-0.1f, 0.4f, 0.0f, //izquierda
		0.1f, 0.1f, 0.0f,  //derecha
		0.1f, 0.4f, 0.0f,    //arriba
		-0.15f, 0.4f, 0.0f, //izquierda
		0.0f, 0.6f, 0.0f,  //derecha
		0.15f, 0.4f, 0.0f,    //arriba
		-0.4f, 0.5f, 0.0f, //izquierda
		-0.65f, 0.8f, 0.0f,  //derecha
		-0.9f, 0.5f, 0.0f,    //arriba
		0.4f, 0.5f, 0.0f, //izquierda
		0.65f, 0.8f, 0.0f,  //derecha
		0.9f, 0.5f, 0.0f,    //arriba
	};
